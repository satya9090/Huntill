...
public class TalentPoolApplicationMainController {
    ...
    /*
     * @Operation(description = "customer login", responses = {
     *
            ...
            if (Objects.nonNull(checkUserName)) {
                ...
                if (Objects.nonNull(checkEmailId)) {
                    ...
                    if (Objects.nonNull(information)) {
                        ...
                        List<TalentCandidateInformation> talentCandidateInformation = talentPoolService.findAllUser();
                        return ResponseEntity.ok(talentCandidateInformation);
    ...
    public ResponseEntity<Object> saveCandidateInformation(@RequestBody TalentCandidateInformation information) {
        ...
        try {
            ...
            if (Objects.nonNull(information1)) {
                logger.info("inside saveCandidateInformation mapping save profileDetails ==>>successful ");
                return ResponseEntity.ok(information1);
            }
            return new ResponseEntity("Candidate Basic Information save Failed", HttpStatus.BAD_REQUEST);
        } catch (Exception e) {
            System.out.println(e.getMessage());
    ...
    public ResponseEntity<Object> saveCandidateProjectDetails(
        ...
        try {
            ...
            if (Objects.nonNull(projectDetail)) {
                logger.info("inside saveCandidateExperience mapping ==>> successful");
    ...
    public ResponseEntity<Object> saveCandidateEducationDetails(
        ...
        try {
            ...
            if (Objects.nonNull(educationDetail)) {
                logger.info(
                        "inside saveCandidateEducationDetails mapping educationDetails save successful ==>> successful");
            ...
            return new ResponseEntity("Candidate Education Details save Failed", HttpStatus.BAD_REQUEST);
        } catch (Exception e) {
            System.out.println(e.getMessage());
            logger.info("inside saveCandidateEducationDetails mapping educationDetails save fail ==>> fail");
            return new ResponseEntity("Candidate Education Details save Failed", HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<Object> saveCandidateAddressDetails(
        ...
        try {
            ...
            if (Objects.nonNull(address)) {
                logger.info(
                        "inside saveCandidateAddressDetails mapping saveCandidateAddressDetails save successful ==>> successful");
                return ResponseEntity.ok(educationDetail);
            }
            logger.info("inside saveCandidateAddressDetails mapping educationDetails save fail ==>> fail");
            return new ResponseEntity("Candidate Address Details save Failed", HttpStatus.BAD_REQUEST);
        } catch (Exception e) {
            System.out.println(e.getMessage());
            logger.info("inside saveCandidateAddressDetails mapping educationDetails save fail ==>> fail");
            return new ResponseEntity("Candidate Address Details save Failed", HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<Object> saveCandidateProjectDetails(
        ...
        try {
            ...
            if (Objects.nonNull(experienceDetails)) {
                logger.info("inside saveProfessionalDetails mapping ==>> successful");
                return ResponseEntity.ok("ProfessionalDetails Save successful");
            }
            logger.info("inside SaveExperienceDetails mapping ==>> Fail");
            return new ResponseEntity("Save Professional Details save Failed", HttpStatus.BAD_REQUEST);
        } catch (Exception e) {
            System.out.println(e.getMessage());
    ...
    public ResponseEntity<Object> checkValidEmail(@RequestParam("uniqueId") String candidateUniqueId) {

        try {
            TalentCandidateInformation information = talentPoolService.findByCandidateUniqueId(candidateUniqueId);
            if (Objects.nonNull(information)) {
                ...
                if (Objects.nonNull(information)) {
                    return ResponseEntity.ok("mail verify successful");
                } else {
                    return new ResponseEntity("mail not verify ", HttpStatus.BAD_REQUEST);
                }
            } else {
                return new ResponseEntity("mail not verify", HttpStatus.BAD_REQUEST);
            }
    ...
    @ApiOperation(value = "RestPassword ")
            ...
            if (Objects.nonNull(pass)) {
                if (pass.isExpired()) {
                    ...
                    TalentCandidateInformation information = talentPoolService
                            .findByCandidateUniqueId(pass.getCandidateUniqueId());
                    logger.info("updatePassword Method check candidateUniqueId ==>>");
                    if (Objects.nonNull(information)) {
                        ...
                        if (Objects.nonNull(information)) {
                            ...
                            return ResponseEntity.ok("UpdatePassword successful");
                        } else {
    ...
    public ArrayList getCandidateProfileById(@RequestParam("candidateUniqueId") String candidateUniqueId,
                                             HttpSession session) {
        session.setAttribute("candidateUniqueId", candidateUniqueId);
        logger.info("getCandidateProfileById Method call ==>>");
        try {
            ArrayList list = new ArrayList();
            TalentCandidateInformation information = talentPoolService.findByCandidateUniqueId(candidateUniqueId);
            TalentCandidateProjectDetails project = talentPoolService.findProjectDetails(candidateUniqueId);
            TalentCandidateAddress address = talentPoolService
                    .findByCandidateUniqueIdFromCandidateAddress(candidateUniqueId);
            TalentEducationDetails education = talentPoolService.findByCandidateEducationDetails(candidateUniqueId);
            list.add(information);
            list.add(project);
            list.add(address);
            list.add(education);
            session.setAttribute("CandidateInfo", list);
            return list;
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
    ...
    // @Operation(description = "candidate basic Information Update", responses = {
    // @ApiResponse(content = @Content(schema = @Schema(implementation =
    // TalentCandidateInformation.class)), responseCode = "200"), })
    ...
    public ResponseEntity<Object> updateCandidateInformation(@RequestBody TalentCandidateInformation information) {
        ...
        try {
            information1 = talentPoolService.findByCandidateUniqueId(information.getCandidateUniqueId());
            logger.info("updateCandidateInformation Method call check candidateUniqueId ==>>");
            if (Objects.nonNull(information1)) {
                ...
                if (Objects.nonNull(information1)) {
                    return ResponseEntity.ok("candidate basic Information Update successful");
                } else {
                    return new ResponseEntity("candidate basic Information not Update", HttpStatus.BAD_REQUEST);
                }
            } else {
                return new ResponseEntity("candidate basic Information not Update", HttpStatus.BAD_REQUEST);
            }
        ...
        return new ResponseEntity("candidate basic Information not Update", HttpStatus.CONFLICT);
    }
    ...
    public ResponseEntity<Object> updateCandidateAddress(@RequestBody List<TalentCandidateAddress> address) {
        try {
            ...
            addressNew.setCountry(address.get(0).getCountry());
            ...
            addressNew2.setCountry(address.get(1).getCountry());
            ...
            return ResponseEntity.ok("candidate Address Update successful");
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
    ...
    public ResponseEntity<Object> updateCandidateProjectDetails(@RequestBody TalentCandidateProjectDetails project) {
        ...
        try {
            ...
            logger.info("return CandidateProjectDetails  using candidateUniqueId  ==>>");
            if (Objects.nonNull(project1)) {
                ...
                if (Objects.nonNull(project1)) {
                    logger.info("Update candidateProjectDetail   successful ==>>");
                    return ResponseEntity.ok("candidate ProjectDetails Update successful");
                } else {
    ...
    public ResponseEntity<Object> candidateEducationUpdate(@RequestBody TalentEducationDetails education) {
        try {
            ...
            logger.info("return candidateEducationDetails using candidateUniqueId  ==>>");
            if (Objects.nonNull(educationNew)) {
                ...
                if (Objects.nonNull(educationNew)) {
                    logger.info("Update Candidate Education details    ==>>");
                    return ResponseEntity.ok("candidate EducationDetails Update successful");
                } else {
    ...
    // @ApiResponse(content = @Content(schema = @Schema(implementation =
    // TalentCandidateInformation.class)), responseCode = "200"), })
    @DeleteMapping(value = "/userDelete/{candidateUniqueId}")
    public ResponseEntity<Object> deleteById(@RequestParam("candidateUniqueId") String candidateUniqueId) {
        try {
            logger.info("candidateId  ==>>" + candidateUniqueId);
            TalentCandidateInformation information = talentPoolService.findByCandidateUniqueId(candidateUniqueId);
            if (Objects.nonNull(information)) {
                information.setIsActive("N");
                information = talentPoolService.saveCandidateInformation(information);
                logger.info("delete user using candidateUniqueId  ==>>");
    ...
    public ResponseEntity<Object> searchCandidate(@RequestBody TalentCandidateInformation candidateInformation,
        ...
        try {
            ...
            listCandidateInformationSearch = talentPoolService.searchCandidateInformation(candidateInformation);
            System.out.println(listCandidateInformationSearch);
            if (listCandidateInformationSearch.size() != 0) {
                logger.info("Return search candidate information ");
     ...
     * { logger.info("Return search candidate information "); return
    ...
    public String saveQuestionAnswer(@RequestBody TalentQuestionAnswer answer) {
        ...
        if (Objects.nonNull(answer)) {
            return "saveTalentQuestionAnswer save successful";
        } else {
            return null;
        }
